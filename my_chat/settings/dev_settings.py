...
SECRET_KEY = 'django-insecure-hw%tt2e5+fpb#iqrm6cfs8t@5gqj^pa(v+nt-!3d7+1jidq0y2'
...
# ALLOWED_HOSTS = ['0.0.0.0', '127.0.0.1','localhost','isp-simple-chat.herokuapp.com']
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'askelio.official@gmail.com'
EMAIL_HOST_PASSWORD = 'nxidxqsubauuljyu'